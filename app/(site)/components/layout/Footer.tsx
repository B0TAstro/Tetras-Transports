...
export default function Footer() {
  return (
    <footer className="flex flex-col md:flex-row justify-center md:justify-between items-center pr-5 pl-5 md:pr-20 md:pl-20 gap-6 md:gap-0">
      <div className="flex flex-col gap-6 justify-center shrink-0 items-start md:items-center order-1 md:order-none"> 
        <ul className="flex flex-col justify-center items-center md:items-start self-stretch gap-2">
          <li>
