    ...
    <>
      {hero.length > 0 &&
        hero.map((data) => (
          ...
          <section
            key={data._id}
            className="font-inter color-dark-100 flex flex-col items-center text-center bg-cover bg-center"
          ...
          >
            ...
            <div className="flex w-full flex-col gap-3 items-center m-45">
              ...
              <div className="self-stretch text-[16px] font-[400]">
